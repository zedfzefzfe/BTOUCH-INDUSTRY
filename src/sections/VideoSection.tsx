    ...
    >
      ...
      >
        <div className="max-w-lg">
          ...
          <h2
            className={`font-serif text-3xl md:text-4xl lg:text-[54px] text-[#e8e0d0] leading-tight mb-6 transition-all duration-700 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          ...
          {videoSectionConfig.bodyParagraphs.map((paragraph, index) => (
            <p
              key={index}
              className={`text-[#e8e0d0]/80 text-lg leading-relaxed mb-6 transition-all duration-700 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
              }`}
          ...
          {videoSectionConfig.ctaText && (
            ...
            >
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-[#8B5E2A] text-[#e8e0d0] font-light tracking-widest text-sm btn-hover"
              >
                {videoSectionConfig.ctaText}
              </a>
            </div>
