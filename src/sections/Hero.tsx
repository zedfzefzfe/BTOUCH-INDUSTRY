...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="relative z-10 h-full flex flex-col justify-center text-white px-6 md:px-12 lg:px-[170px]">
        <div className="max-w-2xl">
          ...
          <h1
            className={`font-serif text-5xl md:text-6xl lg:text-7xl leading-tight transition-all duration-1000 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
          ...
          {heroConfig.subtitle && (
            <p
              className={`mt-8 text-xl md:text-2xl lg:text-3xl font-light leading-relaxed max-w-2xl transition-all duration-1000 ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
              }`}
